...
<?php
    ...
    if (isset($_SESSION["username"])) {
        //session값에 유저네임이 세팅이 되어있으면 true 아니면 false
        //empty는 값이 들어있는지 안들어있는지에 따라 결정된다.
    ...
    $sql = "insert into board (group_num,depth,ord,id, name, subject, content, regist_day, hit,  file_name, file_type, file_copied) ";
    $sql .= "values($group_num, $depth, $userid, $ord, '$username', '$subject', '$content', '$regist_day', 0, ";
